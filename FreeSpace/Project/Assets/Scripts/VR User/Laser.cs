...
namespace Annotation
{
    ...
    public class Laser : MonoBehaviour
    {
        ...
        public VRInteractionData m_vrInteractionData;
        #endregion
        ...
        private void Awake()
        {
            ...
            {
                m_vrInteractionData.m_handTrans = transform.parent;
                    ...
                    for (int i = 0; i < hit.Length; i++)
                    {
                        ...
                        if (vrInteractable != null && vrInteractable.m_interactable)
                        {
                            ...
                            if (hit[i].distance < closestInteractableDist)
                            {
                                ...
                                m_vrInteractionData.m_hitPoint = hit[i].point;
        ...
        {
            m_triggerInputEventGroup.OnHeld.UnityEvent.RemoveAllListeners();
            m_triggerInputEventGroup.OnPressed.UnityEvent.RemoveAllListeners();
            m_triggerInputEventGroup.OnReleased.UnityEvent.RemoveAllListeners();

            m_gripInputEventGroup.OnHeld.UnityEvent.RemoveAllListeners();
            m_gripInputEventGroup.OnPressed.UnityEvent.RemoveAllListeners();
            m_gripInputEventGroup.OnReleased.UnityEvent.RemoveAllListeners();
        }
        ...
        public void ChangeLaseColor(Color color)
        {
            m_lineRenderer.material.SetColor("_Color", color);
        }


        public void ChangeLaseAlpha(float alpha)
        {
            Color color = m_lineRenderer.material.GetColor("_Color");
            color.a = alpha;
