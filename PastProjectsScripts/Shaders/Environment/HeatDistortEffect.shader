Shader "Custom/FX/HeatDistortEffect"
{
	Properties
	{
		_MainTex ("Texture", 2D) = "black" {}
		_NormalMap("Normalmap", 2D) ="bump" {}
		_DistortAmount("Distorion Amount", range(0,500)) = 20
		...
		SubShader
	{
		...
		half4  frag(v2f i) : COLOR
		{
			...
			col.a *= _TexAlphaAmount * _TintColor.a * i.color.a;
			return col;
		}
			ENDCG
...
Tags{ "Queue" = "Transparent-1" "RenderType" = "Transparent" }
		...
		Pass
		{
			...
			half4  frag (v2f i) : COLOR
			{
				...
				col.a = dot(float3(0,0,1), bump) * i.alpha * _DistortAlphaBoost * _TintColor.a * i.color.a;
